...
public class DatabaseQueries {
	...
	public static final String REMOVE_ALL_DOWNLOADS = "DELETE FROM Downloads WHERE AppID = ?";
	public static final String REMOVE_ALL_WISHLIST = "DELETE FROM WishList WHERE AppID = ?";
