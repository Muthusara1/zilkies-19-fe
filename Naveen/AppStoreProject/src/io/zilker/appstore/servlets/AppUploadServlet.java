...
public class AppUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (request.getSession(false).getAttribute("user") == null) {
				...
				validator.checkCategory(request.getParameter("category"));
	...
	private Applications populateApp(HttpServletRequest request) throws Exception {
		LOGGER.info("Entered populateApp");
		try {
		...
		return app;
			...
			LOGGER.info("Exited populateApp");
		}
	}
